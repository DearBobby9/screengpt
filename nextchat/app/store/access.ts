...
const DEFAULT_ACCESS_STATE = {
  ...
  openaiCompatibleProviderName: "Custom",
  openaiCompatibleFetchedModels: [] as string[],
...
export const useAccessStore = createPersistStore(
  ...
  (set, get) => ({
    ...
    isValidOpenAICompatible() {
      return ensure(get(), ["openaiCompatibleUrl", "openaiCompatibleApiKey"]);
    },
